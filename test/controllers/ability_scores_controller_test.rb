...
class AbilityScoresControllerTest < ActionController::TestCase
  ...
  test "should create ability_score" do
    assert_difference('AbilityScore.count') do
      post :create, ability_score: { name: @ability_score.name, race_modifier: @ability_score.race_modifier, temp_modifier: @ability_score.temp_modifier }
    end
  ...
  test "should update ability_score" do
    patch :update, id: @ability_score, ability_score: { name: @ability_score.name, race_modifier: @ability_score.race_modifier, temp_modifier: @ability_score.temp_modifier }
    assert_redirected_to ability_score_path(assigns(:ability_score))
  end
